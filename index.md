...
## <span style="color: var(--alert-color);">【物理情報工学科新4年生向け】</span>
...
<iframe
  src="slidedeck.pdf"
  style="margin-top: 1ex; margin-bottom: 1ex; width: 100%; aspect-ratio: 16 / 9; outline: 1px solid #ccc; display: block;"
></iframe>
...
<div class="history-list" markdown>
...
<div class="card-grid">
    <a href="#magnetic-resonance-imaging" class="card card-link">
        <h3>磁気共鳴イメージング</h3>
        <p>磁気共鳴現象に基づいて体内を画像化するMRIを用いて生体組織の物性値を画像化する研究に取り組んでいます。</p>
    </a>
    <a href="#neuromagnetic-imaging" class="card card-link">
        <h3>磁気神経イメージング</h3>
        <p>脳内の神経活動に伴って漏れ出る磁気を測定する脳磁図(MEG)を用いて神経活動のマッピングに取り組んでいます。</p>
    </a>
    <a href="#magnetic-particle-imaging" class="card card-link">
        <h3>磁気粒子イメージング</h3>
        <p>MRIとMEGの研究を活かして、体内に導入した磁性ナノ粒子を高感度に捉えるMPIの研究を立ち上げているところです。</p>
    </a>
</div>
...
## 磁気粒子イメージング {: data-subheading="MAGNETIC PARTICLE IMAGING" id="magnetic-particle-imaging" }
